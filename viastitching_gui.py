...
class viastitching_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		# -----------------------------------------------------------------------
		# NEW: Stagger row checkbox
		# -----------------------------------------------------------------------
		bHSizerStagger = wx.BoxSizer( wx.HORIZONTAL )
		...
		self.m_chkStagger.SetValue(False)
		self.m_chkStagger.SetToolTip( _(u"When enabled, every second row is shifted horizontally by half the horizontal spacing, creating a brick-like / offset pattern.") )

		bHSizerStagger.Add( self.m_chkStagger, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

		bMainSizer.Add( bHSizerStagger, 1, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5 )
		# -----------------------------------------------------------------------
